 ...
 *     original instead. Frame count is read from the container (no decode).
...
class TransformImageAction extends BaseTransformImageAction
{
     ...
     * hits pay nothing. Frame count is read from the container — no pixel decode.
     * Disabled when max_animated_frames <= 0.
     */
